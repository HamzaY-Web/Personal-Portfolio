...
const socialLinks = [
  { icon: Github, href: 'https://github.com/HamzaY-Web' },
  { icon: Linkedin, href: 'https://www.linkedin.com/in/hamza-mousa-475583395/' },
]
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                Hi, I'm Hamza Yousef — a junior Web Developer specializing in
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in animation-delay-300">
              ...
              <AnimatedBorderButton href="/assets/Hamza-Yousef-CV.pdf" download='Hamza-CV.pdf'>
            ...
            <div className="relative animate-fade-in animation-delay-500">
              ...
              <div className="relative max-w-md mx-auto">
                ...
                <div className="relative rounded-3xl glass p-2 glow-border">
                  ...
                  {/* Stats Badge */}
                  <div className="absolute -top-3 -left-3 glass rounded-xl px-3 py-2 animate-float animation-delay-500">
